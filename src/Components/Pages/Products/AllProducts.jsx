                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white py-1 rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg"
                                        >
                                            Add Cart
                                        </button>
                                    </div>
